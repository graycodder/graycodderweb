...
const en = {
  ...
  // Hero Section
  "hero.excellence": "Complete End-to-End AI Solutions for Business",
  "hero.title": "Scale & Automate Your Business with AI",
  "hero.description": "Empowering business owners with full-spectrum AI integration, intelligent automation, custom software solutions, and strategic AI consulting to multiply growth.",
  "hero.servicesBtn": "Explore AI Services",
  "hero.contactBtn": "Book AI Consultation",
  "hero.experienceVal": "14+",
  "hero.experienceLabel": "Years IT Experience",
  "hero.projectsVal": "3+",
  "hero.projectsLabel": "AI & Tech Deployments",
  "hero.clientsVal": "5+",
  "hero.clientsLabel": "Happy Businesses",

  // About Section
  "about.title": "About Graycodder AI",
  "about.subtitle": "Your complete AI operating partner for business automation, software, and intelligence",
